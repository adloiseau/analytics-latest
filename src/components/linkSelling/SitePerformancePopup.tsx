...
interface SitePerformancePopupProps {
...
export const SitePerformancePopup: React.FC<SitePerformancePopupProps> = ({
  sitePerformance,
  filters,
  onClose
}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#25262b] rounded-lg p-6 w-[90vw] max-w-6xl relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6">
          <h2 className="text-xl font-bold text-white mb-2">Répartition par Site</h2>
        </div>
          ...
          <div>
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={sitePerformance} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
        ...
        <div className="grid grid-cols-4 gap-4 text-center bg-[#1a1b1e]/50 rounded-lg p-4">
          <div>
            <div className="text-2xl font-bold text-white">{sitePerformance.length}</div>
